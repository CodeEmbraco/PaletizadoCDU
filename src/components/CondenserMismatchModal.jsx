...
function CondenserMismatchModal({
  open,
  onClose,
  expectedProduct,
  scannedProduct,
  ...
  return (
    ...
    >
      <div className="text-center text-white px-8 w-full max-w-5xl">
        ...
        >
          El material del condensador escaneado NO corresponde al producto de la
          orden seleccionada.
          <br />
          Verifica el componente antes de continuar.
        </p>

        {scannedSerial ? (
          <p
            className="font-mono mb-8 break-all"
            style={{ fontSize: "20px", color: "#fde68a" }}
          >
            Serial escaneado: {scannedSerial}
          </p>
        ) : null}
        ...
        <div className="grid grid-cols-2 gap-6 mb-10">
          ...
          <div className="border-4 border-yellow-300 rounded-lg p-6 bg-red-900">
            ...
            >
              Material del condensador escaneado
            </p>
            <p
              className="font-mono font-black break-all"
              style={{ fontSize: "40px", color: "white" }}
...
export default CondenserMismatchModal;
